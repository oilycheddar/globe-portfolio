...
export const themes = {
    slime: {
      ...
      "--page-noise": "url('/images/optimized/slime_page_noise-q70.webp')", /* Page content noise */
    ...
    water: {
        ...
        "--page-noise": "url('/images/optimized/page-noise-water-q70.webp')", /* Page content noise */
    ...
    acid: {
        ...
        "--page-noise": "url('/images/optimized/page-noise-acid-q70.webp')", /* Page content noise */
    ...
    bunny: {
        ...
        "--page-noise": "url('/images/optimized/page-noise-bunny-q70.webp')", /* Page content noise */
    ...
    dune: {
        ...
        "--page-noise": "url('/images/optimized/page-noise-dune-q70.webp')", /* Page content noise */
