      ...
      <ContentWrapper>
        ...
        >
          ...
          >
              ...
              I built this site using Cursor and designed the 3D logo using three.js. Learning to code made me 10x more curious and detail oriented. there's no going back now. This project is <StyledLink href="https://github.com/oilycheddar/globe-portfolio" target="_blank" rel="noopener noreferrer">open</StyledLink><StyledLink href="https://github.com/oilycheddar/globe-portfolio" target="_blank" rel="noopener noreferrer"> source</StyledLink>.<br /><br />You can also open it in your CLI using npx georgevisan.
