      ...
      <ContentWrapper>
        ...
        >
          ...
          >
              ...
              I designed and developed this site from scratch, co-authored with Claude. Learning to code made me more curious and detail oriented. For the nerds, this website is also available in the CLI by running NPX georgebugg. This project is <StyledLink href="https://github.com/oilycheddar/globe-portfolio" target="_blank" rel="noopener noreferrer">open</StyledLink><StyledLink href="https://github.com/oilycheddar/globe-portfolio" target="_blank" rel="noopener noreferrer"> source</StyledLink>.
